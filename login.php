...
<body>
    <div id="login_div">
         ...
         <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 center">
                    ...
                    <p class="forgot"><a href="reset.php" class="link" >Forgot password?</a></p>
                    <button class="btn btn-primary" id="loading" data-loading-text="Loading..." onclick="login()" autocomplete="off"> SIGN IN</button>
                </div>
        ...
        <div id="user_div">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="index.php"><img src="images/rectangle.png" class="image"></a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
           ...
           <section class="section">
            ...
            <div class="row">
                <div class="col-md-12 printer">
                    <img src="images/prin.png" alt="">
                    <h5 style="font-size:20px;">Print your important documents on time!</h5>
                </div>
            </div>
           <div class="row">
                <div class="col-md-6 pdf1">
                    <img src="images/pdf1.png" alt="">
                    <h5><a href="pdf.php" style="color:#000;">Click here to upload your pdf files (PDF)</a></h5>
                </div>
                <div class="col-md-6 pdf2">
                    <img src="images/seo.png" alt="">
                    <h5><a href="research.php" style="color:#000;">Research Project Printing (PDF)</a></h5>
                </div>
            </div>
           </section>
