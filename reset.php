         ...
         <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 center">
                    <label for="name_field"><p class="email">Enter your email: </p></label>
                    <input type="text" id="email_field" class="form-control" placeholder="Email" required /><br>
                    <button class="btn btn-primary" id="loading" onclick="forgot_password()">Reset Password</button>
